...
std::string knot_filename = "pringle";      //if FROM_SURFACE_FILE assumed input filename format of "XXXXX.stl"
...
const int initialNx = 271;   //No. points in x,y and z
const int initialNy = 271;
const int initialNz = 271;
// timestep
